...
import { useState, useCallback, forwardRef, type ForwardedRef } from "react";
...
export const ImageUploader = forwardRef<HTMLImageElement, ImageUploaderProps>(
  (props: ImageUploaderProps, ref: ForwardedRef<HTMLImageElement>) => {
    const { onAnalysisComplete, onAnalysisStart } = props;
